...
const Navbar = () => {
  ...
  <ul className="dropdown-menu">
    <li><Link className="dropdown-item" to="/akhuwat-bussiness-loan">Asaan Qarz Business Loan</Link></li>
    <li><Link className="dropdown-item" to="/akhuwat-house-loan">Asaan Qarz House Loan</Link></li>
  </ul>
</li>
